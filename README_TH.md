...
> - แพ็กเกจฉบับเต็มที่แนะนำมาพร้อม KataGo `v1.17.0` และ Transformer ขนาดกลางทางการ ซึ่งแสดงเป็น “Transformer 10B รุ่นสมดุล” (ประมาณ 94 MB) ส่วนแพ็กเกจอัปเดตเฉพาะตัวโปรแกรมไม่มีเอนจินและโมเดล

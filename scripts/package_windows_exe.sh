...
TENSORRT_KATAGO_TAG="${TENSORRT_KATAGO_TAG:-v1.17.1}"
TENSORRT_KATAGO_ASSET="${TENSORRT_KATAGO_ASSET:-katago-${TENSORRT_KATAGO_TAG}-trt10.9.0-cuda12.8-windows-x64.zip}"
TENSORRT_KATAGO_SHA256="${TENSORRT_KATAGO_SHA256:-b5de0178194cf728c12994cf0ace8a105597e864e0d42d7c6b4e0a1e9ea7a943}"

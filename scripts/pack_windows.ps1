...
# ---------------------------------------------------------------- 3. jpackage
Write-Host "[3/5] jpackage app-image..." -ForegroundColor Yellow
...
Write-Host "[4/5] 注入版本与堆参数..." -ForegroundColor Yellow
...
$add = "java-options=-Dlizzie.next.version=$Version`r`n" +
       ...
       "java-options=-XX:MaxRAMPercentage=50.0`r`n" +
...
# ---------------------------------------------------------------- 5. assemble bundle
Write-Host "[5/5] 组装整合包 $bundleDir ..." -ForegroundColor Yellow
